      ...
      <DialogBackdrop className="fixed inset-0 bg-black/75 transition-opacity" />
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            <DialogPanel
              transition
              className="relative transform overflow-hidden rounded-b-lg rounded-t-lg bg-white shadow-xl transition-all md:max-w-[620px] md:min-w-[620px] w-full"
            >
                {image && (
              ...
              type='button'
              className='px-4 py-2 text-sm font-semibold text-slate-700 hover:text-slate-800 hover:border-slate-800 rounded-md border rounded-b-lg rounded-t-lg'
              >
              Close
              </button>
            </div>
